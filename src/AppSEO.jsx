        ...
        <div className="grid gap-8 md:grid-cols-12">
          ...
          <div className="space-y-4 md:col-span-3">
            ...
            <div className="flex gap-4 mt-4">
              ...
              <a href="https://www.facebook.com/profile.php?id=61580022617531" aria-label="Facebook" className="text-slate-400 hover:text-white">
    ...
    <>
      ...
      <main>
        ...
        <header className="relative isolate overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-900">
          ...
          <div className="relative z-10 mx-auto grid max-w-6xl items-center gap-10 px-6 py-20 md:grid-cols-2 md:py-28">
            <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6}} className="relative z-20">
            ...
            <motion.div initial={{opacity:0,y:20}} animate={{opacity:1,y:0}} transition={{duration:0.6, delay:0.15}} className="relative z-10">
...
// Simple footer pages have been replaced with full-featured versions
