...
const PrivacyPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Helmet>
        <title>Privacy Policy | Watt Utilities - Your Data Protection Rights</title>
        <meta name="description" content="Watt Utilities Privacy Policy. Learn how we collect, use, and protect your personal data in compliance with UK data protection laws." />
        <meta name="keywords" content="privacy policy, data protection, GDPR, personal data, Watt Utilities privacy" />
        <link rel="canonical" href="https://www.wattutilities.co.uk/privacy" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Privacy Policy",
            "description": "Watt Utilities privacy policy and data protection information",
            "url": "https://www.wattutilities.co.uk/privacy",
            "publisher": {
              "@type": "Organization",
              "name": "Watt Utilities",
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 space-y-8">
            ...
            <div>
              ...
              <div className="prose prose-invert max-w-none text-gray-300">
                <p className="mb-4">
                  Watt Utilities Ltd ("WATT", "we", "us", or "our") respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website www.wattutilities.co.uk (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you.
                </p>
                <p className="mb-4">
            ...
            <div>
              ...
              <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                <div className="space-y-3 text-gray-300">
                  <p><strong>Company:</strong> Watt Utilities Ltd</p>
                  <p><strong>Data Protection Officer:</strong> Peter Hunter</p>
                  <p><strong>Email:</strong> <a href="mailto:Peter@watt.co.uk" className="text-emerald-400 hover:text-emerald-300">Peter@watt.co.uk</a></p>
                  <p><strong>Phone:</strong> <a href="tel:01618338661" className="text-emerald-400 hover:text-emerald-300">0161 833 8661</a></p>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="grid gap-4">
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Contact Data</h3>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Transaction Data</h3>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Marketing and Communications Data</h3>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <p className="mt-4">
                  ...
                  <a href="mailto:Peter@watt.co.uk" className="text-emerald-400 hover:text-emerald-300">Peter@watt.co.uk</a>.
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <ul className="space-y-2 ml-6">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Contacting us at <a href="mailto:Peter@watt.co.uk" className="text-emerald-400 hover:text-emerald-300">Peter@watt.co.uk</a></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400">•</span>
                    <span>Calling us on <a href="tel:01618338661" className="text-emerald-400 hover:text-emerald-300">0161 833 8661</a></span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-emerald-400">•</span>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                  ...
                  <p className="text-sm">Website: <a href="https://www.ico.org.uk" target="_blank" rel="noopener noreferrer" className="text-emerald-400 hover:text-emerald-300">www.ico.org.uk</a></p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-lg p-8 border border-emerald-500/30">
              <h2 className="text-2xl font-bold text-white mb-4 text-center">Contact Our Data Protection Officer</h2>
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">Email DPO</p>
                  <a href="mailto:Peter@watt.co.uk" className="text-emerald-400 hover:text-emerald-300">Peter@watt.co.uk</a>
                </div>
                <div>
