                ...
                <div className={`bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl overflow-hidden border transition-all duration-300 h-full ${
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-4">
                      <div className="p-3 rounded-lg bg-gradient-to-r from-indigo-500/20 to-purple-600/20">
                ...
                <div className="flex items-start justify-between mb-6">
                  <div>
                    <div className="flex items-center gap-4 mb-3">
                      <div className="p-3 rounded-lg bg-gradient-to-r from-indigo-500/30 to-purple-600/30">
