  ...
  const testimonials = [
    {
      ...
      rating: 5,
      date: "2024-01-15",
      text: "Watt Utilities saved us £47,000 per year on electricity across our three sites. Their team handled everything professionally and we experienced zero downtime during the switch. Highly recommended!",
      savings: "£47,000/year",
    ...
    },
    {
      ...
      rating: 5,
      date: "2024-01-10",
      text: "After years of overpaying, Watt Utilities negotiated a 35% reduction in our gas and electricity costs. The process was seamless and their ongoing support is exceptional.",
    ...
    },
    {
      ...
      rating: 5,
      date: "2023-12-20",
      text: "The team at Watt Utilities didn't just save us money on energy - they sorted our broadband and telecoms too. One supplier relationship for everything has simplified our operations significantly.",
      savings: "£18,500/year",
      category: "Technology"
    },
    {
      ...
      rating: 5,
      date: "2023-12-15",
      text: "Managing energy for 12 care homes was a nightmare until Watt Utilities took over. They secured us a basket contract that's saved us over £85,000 annually. Fantastic service!",
      savings: "£85,000/year",
      category: "Healthcare"
    },
    {
      ...
      rating: 5,
      date: "2023-11-28",
      text: "As a family business, every penny counts. Watt Utilities reduced our energy costs by 42% and the savings have allowed us to invest in new equipment and grow the business.",
    ...
    },
    {
      ...
      rating: 5,
      date: "2023-11-20",
      text: "We've worked with several energy brokers over the years, but Watt Utilities stands out. Their market knowledge and negotiation skills secured us rates we didn't think were possible.",
    ...
    },
    {
      ...
      rating: 5,
      date: "2023-10-25",
      text: "Watt Utilities monitors our contracts and always contacts us before renewal. We never worry about rolling onto expensive out-of-contract rates anymore. Peace of mind is priceless.",
      savings: "£31,000/year",
      category: "Wholesale"
    }
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <SEOHead
        ...
        description="Read what our customers say about Watt Utilities. Real reviews from businesses that have saved thousands on their energy bills."
        ...
        <div className="container mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 gap-8">
            {testimonials.map((testimonial, index) => (
              ...
              >
                {/* Quote Icon */}
                <Quote className="absolute top-4 right-4 w-8 h-8 text-emerald-400/20" />
                ...
                {testimonial.savings && (
                  <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/30 rounded-full px-4 py-2 mb-6">
                    ...
                    <span className="text-emerald-400 font-semibold">Saved: {testimonial.savings}</span>
                  </div>
                )}
