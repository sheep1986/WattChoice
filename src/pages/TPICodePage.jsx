...
const TPICodePage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Helmet>
        <title>TPI Code of Conduct | Watt Utilities - Third Party Intermediary Standards</title>
        <meta name="description" content="Watt Utilities TPI Code of Conduct. Our commitment to ethical standards, customer protection, and regulatory compliance as a Third Party Intermediary." />
        ...
        <link rel="canonical" href="https://www.wattutilities.co.uk/tpi-code" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Watt Utilities Third Party Intermediary code of conduct and ethical standards",
            "url": "https://www.wattutilities.co.uk/tpi-code",
            "publisher": {
              "@type": "Organization",
              "name": "Watt Utilities",
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        >
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">TPI Code of Conduct</h1>
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 space-y-8">
            ...
            <div>
              ...
              <div className="prose prose-invert max-w-none text-gray-300">
                <p className="mb-4">
                  As a Third Party Intermediary (TPI), Watt Utilities is committed to maintaining the highest standards of professional conduct and customer service. This code establishes our principles for responsible business practices when working between micro-business customers and energy suppliers.
                </p>
                <p className="mb-4">
                ...
                <div className="bg-blue-900/20 border border-blue-500/30 rounded-lg p-4 mt-6">
                  <p className="text-sm">
                    <strong>Scope:</strong> This code applies to all Watt Utilities activities as a Third Party Intermediary in the UK energy market, covering interactions with micro-business customers and energy suppliers.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-semibold text-white">Customer Protection</h3>
                  </div>
                ...
                <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <h3 className="font-semibold text-white">Professional Integrity</h3>
                  </div>
                  <p className="text-gray-300 text-sm">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="space-y-4">
                  <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-lg p-6 border border-emerald-500/30">
                    <h3 className="font-semibold text-white mb-3">Recruitment Process</h3>
                  ...
                  <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg p-6 border border-blue-500/30">
                    <h3 className="font-semibold text-white mb-3">Training Requirements</h3>
                    <ul className="space-y-2 text-sm">
                      <li className="flex items-start gap-2">
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                  <h3 className="font-semibold text-white mb-4">Key Compliance Areas</h3>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                    ...
                    <div>
                      <h4 className="font-semibold text-emerald-400 mb-2">Marketing Consent</h4>
                      <ul className="space-y-1 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="text-emerald-400">•</span>
                    ...
                    <div>
                      <h4 className="font-semibold text-emerald-400 mb-2">Change of Tenancy</h4>
                      <ul className="space-y-1 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="text-emerald-400">•</span>
                    ...
                    <div>
                      <h4 className="font-semibold text-emerald-400 mb-2">Legal Requirements</h4>
                      <ul className="space-y-1 text-sm">
                        <li className="flex items-start gap-2">
                          <span className="text-emerald-400">•</span>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Process Transparency</h3>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Response Commitment</h3>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Escalation Procedures</h3>
                  ...
                  <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                    <h3 className="font-semibold text-white mb-2">Record Keeping</h3>
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div className="bg-gradient-to-br from-amber-500/10 to-orange-500/10 rounded-lg p-6 border border-amber-500/30">
                  <h3 className="font-semibold text-white mb-4">Accountability Measures</h3>
                  <div className="space-y-3">
                    <div className="flex items-start gap-3">
                      <ClipboardCheck className="w-5 h-5 text-amber-400 mt-0.5 flex-shrink-0" />
                      <div>
                        <p className="font-semibold text-white text-sm">Annual Self-Assessment</p>
                        <p className="text-xs text-gray-300">Comprehensive review of all TPI code compliance areas with detailed reporting.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-white text-sm">Independent Audits</p>
                        <p className="text-xs text-gray-300">Subject to supplier and independent third-party audits to verify compliance standards.</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-white text-sm">Sanctions for Non-Compliance</p>
                        <p className="text-xs text-gray-300">Potential consequences for code breaches including corrective action plans and contract termination.</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-lg p-6 border border-emerald-500/30">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    <h3 className="font-semibold text-white mb-3">Service Standards</h3>
                  ...
                  <div>
                    <h3 className="font-semibold text-white mb-3">Protection Measures</h3>
                    <ul className="space-y-2 text-sm text-gray-300">
                      <li className="flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-emerald-400 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-lg p-8 border border-emerald-500/30">
              <h2 className="text-2xl font-bold text-white mb-4 text-center">Questions About Our TPI Standards?</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-400 mt-1">Business hours</p>
                </div>
              </div>
            </div>
