...
const ServicesPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-gray-100 to-white">
      <Helmet>
        <title>Business Utility Services | Electricity, Gas, Water & More | Watt Choice</title>
        ...
        <link rel="canonical" href="https://www.wattchoice.co.uk/services" />
        
        {/* Open Graph */}
        <meta property="og:title" content="Business Utility Services | Save up to 45% | Watt Choice" />
        ...
        <meta property="og:url" content="https://www.wattchoice.co.uk/services" />
        
        {/* Twitter Card */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Business Utility Services | Watt Choice" />
            ...
            {services.map((service, index) => (
              ...
              >
                <Link to={service.link}>
                  <div className="h-full bg-gray-100/50 border border-gray-200 rounded-lg p-6 hover:border-emerald-500 hover:bg-gray-100/70 transition-all">
                    <div className="flex items-start justify-between mb-4">
                      <service.icon className={`w-10 h-10 ${service.color}`} />
                      <span className="text-xs text-green-600 font-semibold bg-green-500/10 px-2 py-1 rounded">
                        {service.savings}
                      </span>
                    </div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="https://www.app.watt.co.uk" target="_blank" rel="noopener noreferrer">
              <button className="bg-green-500 hover:bg-emerald-600 text-gray-900 font-bold py-4 px-8 rounded-lg shadow-lg flex items-center gap-2 transition-colors">
                Get Free Quotes <ArrowRight className="w-5 h-5" />
              </button>
            </a>
            <a href="tel:01618338661" className="bg-gray-100 hover:bg-gray-200 text-gray-900 font-bold py-4 px-8 rounded-lg border border-gray-200 flex items-center gap-2 transition-colors inline-flex">
