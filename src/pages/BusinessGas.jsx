    ...
    <>
          ...
          >
            ...
            <div className="flex flex-wrap gap-4 mb-12">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="bg-orange-500 hover:bg-orange-600 text-gray-900 font-bold py-4 px-8 rounded-lg shadow-lg flex items-center gap-2"
              >
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-4 text-center">
                ...
                <div className="text-sm text-gray-700">Gas Suppliers</div>
              </div>
              <div className="bg-white/10 backdrop-blur rounded-lg p-4 text-center">
              ...
              <div className="bg-white/10 backdrop-blur rounded-lg p-4 text-center">
                ...
                <div className="text-sm text-gray-700">Free Service</div>
              </div>
            </div>
          </motion.div>
        </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <motion.a 
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-gray-900 font-bold py-3 px-6 rounded-lg transition-all"
              >
            ...
            >
              ...
              />
              <div className="absolute -bottom-6 -right-6 bg-gradient-to-r from-orange-500 to-red-500 text-gray-900 p-6 rounded-lg shadow-lg">
              ...
              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-900">NBP Day Ahead</span>
                    <span className="text-orange-400 font-bold">68.5p/therm</span>
                  </div>
                  <div className="text-xs text-gray-600">-2.3% from last week</div>
                </div>
                
                <div className="bg-white/10 backdrop-blur rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-900">UK Storage Level</span>
                ...
                <div className="bg-white/10 backdrop-blur rounded-lg p-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-gray-900">Average Business Rate</span>
                    <span className="text-orange-400 font-bold">7.2p/kWh</span>
                  </div>
                  <div className="text-xs text-gray-600">Fixed 12-month contract</div>
                </div>
              </div>
            </div>
          ...
          <div className="relative">
            ...
            {content.mainContent.process.map((step, index) => (
              ...
              >
                ...
                <div className="absolute left-1/2 transform -translate-x-1/2 w-12 h-12 bg-orange-500 rounded-full flex items-center justify-center text-gray-900 font-bold shadow-lg">
                  {step.step}
                </div>
        ...
        <div className="container mx-auto max-w-4xl text-center">
          <div className="bg-white/10 backdrop-blur rounded-2xl p-8 md:p-12">
            ...
            <blockquote className="text-2xl text-gray-900 mb-6 italic">
              "Watt Choice saved us £32,000 on our annual gas bill. Their market knowledge 
      ...
      <section className="py-16 px-4 bg-gradient-to-r from-orange-500 to-red-500">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-xl text-gray-900/90 mb-8">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="bg-black/20 hover:bg-black/30 text-gray-900 font-bold py-4 px-8 rounded-lg shadow-lg flex items-center gap-2 backdrop-blur"
            >
              <Phone /> 0161 833 8661
            </motion.a>
          </div>
