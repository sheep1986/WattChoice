...
const ComplaintsPage = () => {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
      <Helmet>
        <title>Complaints Procedure | Watt Utilities - Customer Service & Resolution</title>
        <meta name="description" content="Watt Utilities complaints procedure. Learn how to raise concerns, our resolution process, escalation procedures, and ombudsman contact details." />
        <meta name="keywords" content="complaints procedure, customer service, dispute resolution, ombudsman, escalation process, Watt Utilities complaints" />
        <link rel="canonical" href="https://www.wattutilities.co.uk/complaints" />
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "Watt Utilities complaints handling procedure and customer service information",
            "url": "https://www.wattutilities.co.uk/complaints",
            "publisher": {
              "@type": "Organization",
              "name": "Watt Utilities",
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        >
          <div className="text-center mb-12">
            ...
            <h1 className="text-5xl md:text-6xl font-bold text-white mb-4">Complaints Procedure</h1>
          ...
          <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-8 space-y-8">
            ...
            <div>
              ...
              <div className="prose prose-invert max-w-none text-gray-300">
                <p className="mb-4">
                  At Watt Utilities, we strive to provide excellent service to all our customers. However, we recognize that there may be occasions when you're not satisfied with our service. We take all complaints seriously and are committed to resolving them efficiently and fairly.
                </p>
                <p className="mb-4">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                  ...
                  <p className="text-gray-300 mb-2">
                    <a href="tel:01618338661" className="text-emerald-400 hover:text-emerald-300 font-semibold">0161 833 8661</a>
                  </p>
                  <p className="text-sm text-gray-400">Monday - Friday: 9:00 AM - 5:00 PM</p>
                </div>
                ...
                <div className="bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                  ...
                  <p className="text-gray-300 mb-2">
                    <a href="mailto:resolutions@watt.co.uk" className="text-emerald-400 hover:text-emerald-300 font-semibold">resolutions@watt.co.uk</a>
                  </p>
                  <p className="text-sm text-gray-400">Dedicated complaints email address</p>
                </div>
              </div>
              ...
              <div className="mt-6 bg-slate-900/50 rounded-lg p-6 border border-slate-700">
                ...
                <div className="text-gray-300">
                  <p className="font-semibold">Watt Utilities Customer Services</p>
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-emerald-500/10 to-cyan-500/10 rounded-lg p-6 border border-emerald-500/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-3">Stage One: Initial Investigation</h3>
                      ...
                      <div className="mt-4 bg-slate-800/50 rounded-lg p-4 border border-slate-600">
                        <p className="text-sm text-gray-300">
                          <Clock className="w-4 h-4 text-emerald-400 inline mr-2" />
                ...
                <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-lg p-6 border border-blue-500/30">
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h3 className="text-xl font-semibold text-white mb-3">Stage Two: Independent Escalation</h3>
                      <div className="space-y-3 text-gray-300">
                        <div className="flex items-start gap-2">
                      ...
                      <div className="mt-4 bg-slate-800/50 rounded-lg p-4 border border-slate-600">
                        <p className="text-sm text-gray-300">
                          <Shield className="w-4 h-4 text-blue-400 inline mr-2" />
            ...
            <div>
              ...
              <div className="bg-amber-900/20 border border-amber-500/30 rounded-lg p-6">
                <h3 className="font-semibold text-white mb-3">Special Rights for Micro Businesses</h3>
                ...
                <div className="bg-slate-900/50 rounded-lg p-4 border border-slate-700">
                  <h4 className="font-semibold text-white mb-2">Ombudsman Services: Energy</h4>
            ...
            <div>
              ...
              <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-lg p-6 border border-slate-700">
                <div className="grid md:grid-cols-4 gap-4 text-center">
                  <div>
                    <div className="text-2xl font-bold text-emerald-400 mb-1">24 Hours</div>
                    <p className="text-sm text-gray-400">Email acknowledgment</p>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-400 mb-1">28 Days</div>
                    <p className="text-sm text-gray-400">Stage One resolution</p>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-purple-400 mb-1">28 Days</div>
                    <p className="text-sm text-gray-400">Stage Two resolution</p>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-amber-400 mb-1">8 Weeks</div>
                    <p className="text-sm text-gray-400">Ombudsman referral</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-emerald-500/10 to-cyan-500/10 rounded-lg p-8 border border-emerald-500/30">
              <h2 className="text-2xl font-bold text-white mb-4 text-center">Ready to Raise a Complaint?</h2>
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div>
                  ...
                  <p className="text-white font-semibold">Call Our Team</p>
                ...
                <div>
                  ...
                  <p className="text-white font-semibold">Email Resolutions</p>
                  <a href="mailto:resolutions@watt.co.uk" className="text-emerald-400 hover:text-emerald-300">resolutions@watt.co.uk</a>
                  <p className="text-xs text-gray-400 mt-1">Dedicated complaints email</p>
                </div>
                <div>
                  <MapPin className="w-8 h-8 text-emerald-400 mx-auto mb-2" />
                  <p className="text-white font-semibold">Write to Us</p>
                  <p className="text-sm text-gray-400">St Ann's House, Manchester</p>
                  <p className="text-xs text-gray-400 mt-1">Full address above</p>
                </div>
              </div>
            </div>
