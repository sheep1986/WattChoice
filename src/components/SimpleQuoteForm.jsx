    ...
    return (
      <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
        <motion.div
          ...
          className="bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl p-8 max-w-md w-full border border-emerald-500/30"
        >
          <div className="text-center">
            <CheckCircle className="w-16 h-16 text-emerald-400 mx-auto mb-4" />
            <h3 className="text-2xl font-bold text-white mb-2">Quote Request Received!</h3>
            <p className="text-gray-300">
              Thank you, {formData.contactName}. Our team will contact you within 24 hours with competitive quotes.
            </p>
          </div>
        </motion.div>
      </div>
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center p-4">
      <motion.div
        ...
        exit={{ opacity: 0, y: 20 }}
        className="bg-gradient-to-br from-slate-900 to-slate-950 rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto"
      >
        {/* Header */}
        <div className={`bg-gradient-to-r ${colorClasses[serviceDetails.color]} p-6 rounded-t-2xl border-b border-slate-800`}>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-4 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-white placeholder-gray-500 focus:border-emerald-500 focus:outline-none"
          ...
          <div className="space-y-4">
            <h3 className="text-lg font-semibold text-white">Current Service Details</h3>
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div>
                ...
                <select
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-2 bg-slate-800/50 border border-slate-700 rounded-lg text-white focus:border-emerald-500 focus:outline-none"
                >
          ...
          <div className="flex gap-4">
            ...
            <button
              type="button"
              onClick={onClose}
              className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-white font-bold rounded-lg transition-colors duration-200"
            >
              Cancel
            </button>
          </div>
